...
function addNewListingFormSubmit(){
	...
	var errormsg="";
	   ...
	   if(confirm_email==""){witherror=1; errormsg+="Confirm your email.\n";}
		...
		if(growing_space_size_unit==""){witherror=1; errormsg+="Growing space size unit must be provided.\n";}
		if(period_availability==""){witherror=1; errormsg+="Period availability must be provided.\n";}
		
		if(growing_space_cost==""){witherror=1; errormsg+="Growing space cost must be provided.\n";}
		if(currency==""){witherror=1; errormsg+="Currency must be provided.\n";}
		if(growing_space_period==""){witherror=1; errormsg+="Growing space period must be provided.\n";}
		if(growing_space_onsite_tools==""){witherror=1; errormsg+="Growing space onsite tools must be provided.\n";}
		if(growing_space_parking==""){witherror=1; errormsg+="Growing space parking must be provided.\n";}
		if(growing_space_accommodation==""){witherror=1; errormsg+="Growing space accommodation must be provided.\n";}
		if(growing_space_organic_certification==""){witherror=1; errormsg+="Growing space organic certification must be provided.\n";}
		if(growing_space_site_access_time==""){witherror=1; errormsg+="Growing space site_access time must be provided.\n";}		
