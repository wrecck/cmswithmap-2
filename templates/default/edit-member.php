  ...
  <div class="module_box_left">
	...
	<br clear="all"><br>
		<div class="rows">  
		  ...
		  <div class="field">
	  <input onClick="swithType(1);" type="radio" <?php if($memberData["profile_type"]!=4){echo "checked";}?>  name="profile_type"  id="member_type1" value="1">&nbsp;Free Registration
	  &nbsp;&nbsp;
      <input onClick="swithType(2);"  type="radio" name="profile_type"  <?php if($memberData["profile_type"]==4){echo "checked";}?>  id="member_type3"  value="4">&nbsp;Premium Account
