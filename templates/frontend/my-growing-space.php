			  ...
			  if(count($growingSpaceListingArr)>0){
			   foreach($growingSpaceListingArr as $data){?>
					 <div class="listing_main_row">  
					   ...
					   <div class="listing_text">
						...
						<div class="listing_options">
							<span class="glyphicon glyphicon-pencil" onClick="location.href='/my-growing-space/?eid=<?php echo $data["id"];?>';"></span><br>
							<span class="glyphicon glyphicon-trash" onClick="confirmDelete('/my-growing-space/?did=<?php echo $data["id"];?>')"></span>
					   </div>
					</div>	
				<?php }
			  }else{
  			  ...
  			  <div class="my_listing_right">
			      <a href="/add-new-growing-space/">Add New</a><br clear="all">
			  </div>		
  		</div>
