...
<center> <b>Utilities</b></center>
	<div class="add_new_listing_right_left"> 
		...
		<input type="checkbox" class="checkbox" value="No utilities at site" name="no_utilities_at_site" id="no_utilities_at_site">
		&nbsp;<span class="check_text">No utilities at site</span><br clear="all">
		<input type="checkbox" class="checkbox" value="Electricity Provided" name="electricity_provided" id="electricity_provided">
		&nbsp;<span class="check_text">Electricity provided</span><br clear="all">
		<input type="checkbox" class="checkbox" value="Electricity available at cost" name="electricity_available_at_cost" id="electricity_available_at_cost">
		&nbsp;<span class="check_text">Electricity available at cost</span><br clear="all">
		<input type="checkbox" class="checkbox" value="Gas provided" name="gas_provided" id="gas_provided">
		&nbsp;<span class="check_text">Gas provided</span><br clear="all">
		<input type="checkbox" class="checkbox" value="Gas provided at cost" name="gas_provided_at_cost" id="gas_provided_at_cost">
		...
		<input type="checkbox" class="checkbox" value="Water provided" name="water_provided" id="water_provided">
		&nbsp;<span class="check_text">Water provided</span><br clear="all">
		<input type="checkbox" class="checkbox" value="Water provided Cost" name="water_provided_cost" id="water_provided_cost">
		&nbsp;<span class="check_text">Water provided Cost</span><br clear="all">
		<input type="checkbox" class="checkbox" value="Delivery contact producer" name="other_check" id="other_check">
		&nbsp;<span class="check_text">Other</span><br clear="all">
		<input type="text" class="form-control full" placeholder="Other"  name="other" id="other" >
...
<select class="form-control threeforths" name="growing_space_style" id="growing_space_style" >
...
<input type="text" class="form-control small"  placeholder="Cost" name="growing_space_cost" value="" id="growing_space_cost">
<span   class="required">*</span>
