...
<input type="text" class="form-control full" name="event_seminar_title" id="event_seminar_title" placeholder="Event/Seminar Title" value="<?php echo $userData["event_seminar_title"];?>" name="event_seminar_title" id="event_seminar_title"><span class="required">*</span>
<br clear="all">
	
<textarea placeholder="Introduction" class="form-control small" name="introduction" id="introduction"></textarea><span class="required">*</span>		
<br clear="all">
...
<br clear="all">
<input type="text" class="form-control small" placeholder="Cost" name="cost" id="cost">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                     <div class="input-prepend input-group">
                       ...
                       <input type="text" style="width: 400px" name="date_time" id="date_time" class="form-control" value="<?php echo date("m/d/Y")." 1:00 PM - ".date("m/d/Y")." 2:00 PM";?>"  class="span4"/>
                     </div>
                    </div>
                  </div>
                 </fieldset>
